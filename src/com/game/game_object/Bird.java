...
public class Bird extends ParticularObject {
  ...
  public Bird(float x, float y, GameWorld gameWorld) {
    ...
    backAnim = CacheDataLoader.getInstance().getAnimation("bird");
    forwardAnim = CacheDataLoader.getInstance().getAnimation("bird");
  ...
  public void attack() {
    ...
    shooting.play();
    Bullet bullet = new VioletBullet(getPosX(), getPosY(), getGameWorld());
  ...
  public void update() {
    ...
    if (getPosX() - getGameWorld().naruto.getPosX() > 0)
